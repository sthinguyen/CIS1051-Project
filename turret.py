...
class Turret(pg.sprite.Sprite):
  def __init__(self, sprite_sheets, tile_x, tile_y, shot_fx, upgrade_fx, turret_type=0):
    pg.sprite.Sprite.__init__(self)
    self.turret_type = turret_type
    self.upgrade_level = 1
    index = self.turret_type * 4 + (self.upgrade_level - 1)
    self.range = TURRET_DATA[index]["range"]
    self.cooldown = TURRET_DATA[index]["cooldown"]
    self.damage = TURRET_DATA[index]["damage"]
